...
export default function Dashboard() {
  ...
  return (
    <div className="relative min-h-screen flex flex-col max-w-md mx-auto">
      ...
      <nav className="fixed bottom-4 left-1/2 -translate-x-1/2 w-[calc(100%-2rem)] max-w-sm glass-strong rounded-full p-2 flex items-center justify-between z-50">
        {[
          ...
          return (
            <button
              ...
              className={`flex-1 flex items-center justify-center gap-2 py-3 rounded-full transition ${active ? "gradient-brand glow-purple text-white" : "text-muted-foreground hover:text-foreground"}`}
            >
